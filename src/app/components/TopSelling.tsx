    ...
    <div className='mt-16 xl:mx-[100px] lg:mx-16 mx-5 '>
        ...
        (
            ...
            {[...Array(1)].map((_, index) => (
                    ...
                    {[...Array(2)].map((_, index) => (
                        <div key={index} className='place-self-center w-64 h-96 bg-[#F0EEED] animate-pulse rounded-xl hidden sm:block lg:hidden'></div>
                    ))}
                    {[...Array(4)].map((_, index) => (
                        <div key={index} className='w-64 h-96 bg-[#F0EEED] animate-pulse rounded-xl hidden lg:block'></div>
                    ))}
            </div>
            </div>
        ):(
