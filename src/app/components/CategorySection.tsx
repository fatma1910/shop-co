  ...
  return (
    <div className='mt-16 xl:mx-[100px] lg:mx-16 mx-5 rounded-[40px] bg-[#F0F0F0] xl:p-16 lg:p-12 md:p-8 p-6  space-y-3'>
        ...
        <div className='flex flex-col md:flex-row gap-3 '>
            <div className='relative rounded-[20px] w-full md:w-[60%] max-h-[289px] overflow-hidden'>
            ...
            <div className='relative rounded-[20px] w-full md:w-[40%] max-h-[289px] overflow-hidden'>
